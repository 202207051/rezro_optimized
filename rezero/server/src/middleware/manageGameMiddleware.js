...
export function validateGameStartQuery(req, res, next) {
  ...
  if (!roomId) {
    return next(
      new AppError(400, ERROR_CODE.INVALID_REQUEST, "방 ID가 필요합니다."),
    );
  }
